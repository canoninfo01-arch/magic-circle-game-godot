...
const FRAGMENT_THRESHOLD_GROWTH := 6  # 2026-08-10：初回召喚(3)後の仲間・強化ペースが速すぎるとの指摘で3→6に変更（2回目以降の伸びを倍に）
...
const WEAPON_ITEM_CHANCE := 0.05  # 2026-07-18：0.06→0.12 / 2026-08-07：0.12→0.08 / 2026-08-10：プレイヤーが強くなるペースが速すぎるとの指摘で0.08→0.05
